 ...
 * @example
 * ```
 * Rest Endpoint `/api/v1/countries?year[gte]=2000&year[lt]=2014&pollutant=CO2&sort=-value,year&fields=countryOrArea,year,value&paginate=1&limit=10`
 * req.query = {
 *
 *               pollutant:'CO2'
 *               countryOrArea:"Austria"
 *               year: { gte: '2000', lt: '2014' },
 *               sort: '-value,year',
 *               fields: 'countryOrArea,year,value',
 *               limit: '10'
 * }
 * ```
 *
...
> {
  ...
  paginate(): APIFeatures<T, U> {
    // if (!this.queryParams.paginate || this.queryParams.limit) {
    //   return this;
    // }
